...
class PurchasesSummaryTab extends Component {
  ...
  getData = (flag) => {
    ...
    if (this.state.entity_name === "company") {
      endpoint = `pos-summary/${this.state.project_id}`;
      fd.append("company_id", this.state.entity_id);
    } else {
                ...
                {!this.state.all_vendors && (
                  <>
                    <tr className="white light-hover">
                      ...
                      <td>
                        <p className="main">
                          {this.percentage(_tpu, _tpu - _tpa)}
                        </p>
                      </td>
                    </tr>
                    <tr className="white light-hover">
                      ...
                      <td>
                        <p className="main">{`${this.percentage(
                          _tpu,
                          _td
                        )}`}</p>
                      </td>
                    ...
                    <tr className="white light-hover">
                      <td>
                        <p className="main">
                          Made Payments vs Deliveries Value
                        </p>
                      </td>
                      <td>
                        {_tpa - _td < 0 && (
