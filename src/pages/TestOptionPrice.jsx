...
class TestOptionPrice extends React.Component {
 constructor(props) {
  super(props);
 ...
 _crop() {
  ...
  //   console.log(compressImage(this.dataURLtoFile(files[i]?.cropped, "file")))
  //   console.log(compressImage(this.dataURLtoFile(cropped), "file"));
 }
                 ...
                 {cover?.src !== "" && (
                  <>
                   <Cropper
                    ...
                    dragMode="move"
                    rotatable={false}
                    // onChange={(e) => this.onCroppChange(e)}
                    zoomOnWheel={true}
...
export default connect(null, mapDispatchToProps)(TestOptionPrice);
